...
let formattedCircleArea = circleArea.toFixed(2);
console.log(formattedCircleArea);
let formattedCircumference = circumference.toFixed(2);
console.log(formattedCircleArea, formattedCircumference);
